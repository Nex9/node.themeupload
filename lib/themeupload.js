...
(function() {
  ...
  Upload = (function() {
    function Upload(inpath) {
      ...
      this.parseYaml = __bind(this.parseYaml, this);
      this.inpath = inpath;
      this.opts = {};
    ...
    Upload.prototype.getDomain = function() {
      this.domain = 'http://imagoblobs.appspot.com';
      if (this.opts.debug) {
    ...
    Upload.prototype.getNextVersion = function() {
      ...
      url = this.domain + '/themeupload/next?ns=' + this.opts.tenant;
    ...
    Upload.prototype.flushCache = function() {
      ...
      url = this.domain + '/themeupload/flushcache';
    ...
    Upload.prototype.cleanup = function() {
      ...
      if (this.opts.setdefault) {
        ...
        url = this.domain + '/themeupload/setdefault/' + this.opts.tenant + '/' + this.version;
    ...
    Upload.prototype.uploadFile = function(filepath) {
      ...
      postData = (function(_this) {
        return function(filedata) {
          var payload, url;
          url = _this.domain + '/themeupload/uploadurl';
          filedata.namespace = _this.opts.tenant;
