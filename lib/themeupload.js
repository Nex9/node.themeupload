...
(function() {
  ...
  Upload = (function() {
    ...
    Upload.prototype.walkFiles = function() {
      ...
      console.log('starting deployment for', this.totalfiles, 'paths');
      _results = [];
      for (i = _i = 0, _len = paths.length; _i < _len; i = ++_i) {
        filepath = paths[i];
        _results.push(this.uploadFile(filepath, i));
      }
      return _results;
    };
    ...
    Upload.prototype.uploadFile = function(filepath, i) {
      ...
      uploadBinary = function(body) {
        ...
        return restler.post(body, data).on('complete', function(data, response) {
          ...
          _this.callcounter -= 1;
          console.log('callcounter...', _this.callcounter);
